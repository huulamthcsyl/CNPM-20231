...
function AbsentPersonDetailPage() {
          ...
          <ThemeProvider theme={theme}>
            ...
            <Grid item xs={10}>
              <CustomizedDatePicker
                format="DD-MM-YYYY"
                slotProps={{
                  textField: { variant: "outlined", height: "58px" },
                }}
                sx={{
                  marginRight: "35px",
                  width: "200px",
            ...
            <Grid item container alignItems={"center"}>
              <Grid item xs={2}>
                <Typography variant="h4">
                  Nơi tạm trú<span style={{ color: "red" }}> (*)</span>
                </Typography>
              </Grid>
              <Grid item xs={10}>
                <TextField
            ...
            <Grid container item xs={12} alignItems={"center"}>
              ...
              <Grid item>
                <CustomizedDatePicker
                  ...
                  label="Đến ngày"
                  slotProps={{
                    textField: { variant: "standard", height: "58px" },
                  }}
                  sx={{
                    marginRight: "35px",
                    width: "200px",
...
export default AbsentPersonDetailPage;
